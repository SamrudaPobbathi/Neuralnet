...
#define TRAIN_IMAGE "./mnist-data/train-images-idx3-ubyte"
#define TRAIN_LABEL "./mnist-data/train-labels-idx1-ubyte"
#define TEST_IMAGE "./mnist-data/t10k-images-idx3-ubyte"
#define TEST_LABEL "./mnist-data/t10k-labels-idx1-ubyte"


//if we want to use fashion mnist
#define F_TRAIN_IMAGE "./fmnist-data/train-images-idx3-ubyte"
#define F_TRAIN_LABEL "./fmnist-data/train-labels-idx1-ubyte"
#define F_TEST_IMAGE "./fmnist-data/t10k-images-idx3-ubyte"
#define F_TEST_LABEL "./fmnist-data/t10k-labels-idx1-ubyte"
...
void load_mnist(char data_type[])
{
    // if(data_type == 'f'){
    if (strcmp(data_type, "f") == 0){
        read_mnist_char(F_TRAIN_IMAGE, NUM_TRAIN, LEN_INFO_IMAGE, SIZE, train_image_char, info_image);
        image_char2float(NUM_TRAIN, train_image_char, train_image);

        read_mnist_char(F_TEST_IMAGE, NUM_TEST, LEN_INFO_IMAGE, SIZE, test_image_char, info_image);
        image_char2float(NUM_TEST, test_image_char, test_image);

        read_mnist_char(F_TRAIN_LABEL, NUM_TRAIN, LEN_INFO_LABEL, 1, train_label_char, info_label);
        label_char2int(NUM_TRAIN, train_label_char, train_label);

        read_mnist_char(F_TEST_LABEL, NUM_TEST, LEN_INFO_LABEL, 1, test_label_char, info_label);
